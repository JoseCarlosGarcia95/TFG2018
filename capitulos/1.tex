...
\begin{definicion}[$\alpha$-corte]
  ...
  \[
    ...
    \]
\end{definicion}
Denotamos por $\mathcal{F}_\mathcal{C}(\IU)$ a la familia de conjuntos de $\IU$ tales que sus $\alpha$-corte son no vacíos.
...
\[
  ...
  %\end{figure}
  Denotamos por $\mathcal{F}_\mathcal{H}(\IU)$ la familia de conjuntos de $\IU$ tales que sus $\alpha$-corte son no vacíos, compactos y convexos en $\IU$.
